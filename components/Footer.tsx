  ...
  return (
    ...
    >
      <footer className='bottom-0 rounded-t-[2rem] bg-gradient-to-t from-[#AA1F18] from-60% to-[#440C0A] to-100% h-3/4 relative z-30'>
        <Image className="rounded-t-[2rem] sm:rounded-tl-none w-full sm:absolute sm:w-[17rem] md:w-[24rem] lg:w-[30rem] xl:w-[38rem] bxl:w-[42rem] h-auto opacity-40 top-0 sm:right-0" src={"/footer/mahmood-farooqui.jpg"} alt="Picture of Mahmood farooqui" width={390} height={310} /> 
